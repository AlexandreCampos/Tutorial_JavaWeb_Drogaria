...
public class ProdutoDAO {
	...
	public void salvar(Produto p) throws SQLException {
		...
		/*
		 * Utilizando 'composição' no 'p.getFabricante().getCodigo()'
		 * 'Produto' faz parte de um 'Fabricante'
		 * Na classe 'Produto' o fabricante foi declarado 'private Fabricante fabricante;'
		 *  O 'p.getFabricante().getCodigo()' vira a chave estrangeira de 'Produto' no BD,
