...
public class FabricanteDAO {
	...
	public void salvar(Fabricante f) throws SQLException {
		...
		// substitui o primeiro '?' por f.getDescrição()
	...
	public Fabricante buscarPorCodigo(Fabricante f) throws SQLException {
		...
		// 'ResulSet' armazena o resultado de uma query
	...
	public static void main(String[] args) {
		...
		f1.setDescricao("NEO QUIMICA");
		
		Fabricante f2 = new Fabricante();
		f2.setDescricao("SANDOZ");
		...
		// BUSCA COM UM RESULTADO (por codigo)
		/*Fabricante f1 = new Fabricante();
		f1.setCodigo(5L);
		Fabricante f2 = new Fabricante();
		f2.setCodigo(7L);
		...
		// BUSCA COM VARIOS RESULTADOS (por descricao)
		/*Fabricante f1 = new Fabricante();
		f1.setDescricao("E");
